        ...
        switch(strtolower(array_shift($args))) {
          case "1":     // QUEST PAGE 1
            $p->sendMessage(TF::BOLD . DARK_GREEN . "Quests page 1:");
              if($p->hasPermission("quest") || $p->hasPermission("quest.1") || $p->hasPermission("quest.1.completed") || $p->getExpLevel() > -1) {
              ...
              if($p->hasPermission("quest") || $p->hasPermission("quest.2") || $p->hasPermission("quest.2.completed") || $p->getExpLevel() > 0) {
              ...
              if($p->hasPermission("quest") || $p->hasPermission("quest.3") || $p->hasPermission("quest.3.completed") || $p->getExpLevel() > 1) {
              ...
              if($p->hasPermission("quest") || $p->hasPermission("quest.4") || $p->hasPermission("quest.4.completed") || $p->getExpLevel() > 2) {
              ...
              if($p->hasPermission("quest") || $p->hasPermission("quest.5") || $p->hasPermission("quest.5.completed") || $p->getExpLevel() > 3) {
          ...
          case "2":
            $p->sendMessage(TF::BOLD . DARK_GREEN . "Quests page 2:");
              if($p->hasPermission("quest") || $p->hasPermission("quest.6") || $p->hasPermission("quest.6.completed") || $p->getExpLevel() > 4) {
            ...
            $p->sendMessage(TF::BOLD . DARK_GREEN . "Quests page 2:");
              if($p->hasPermission("quest") || $p->hasPermission("quest.6") || $p->hasPermission("quest.7.completed") || $p->getExpLevel() < 5) {
            ...
            $p->sendMessage(TF::BOLD . DARK_GREEN . "Quests page 2:");
              if($p->hasPermission("quest") || $p->hasPermission("quest.8") || $p->hasPermission("quest.8.completed") || $p->getExpLevel() < 6) {
            ...
            $p->sendMessage(TF::BOLD . DARK_GREEN . "Quests page 2:");
              if($p->hasPermission("quest") || $p->hasPermission("quest.9") || $p->hasPermission("quest.9.completed") || $p->getExpLevel() < 7) {
            ...
            $p->sendMessage(TF::BOLD . DARK_GREEN . "Quests page 2:");
              if($p->hasPermission("quest") || $p->hasPermission("quest.10") || $p->hasPermission("quest.10.completed") || $p->getExpLevel() < 8) {
